...
public interface PaymentStatusCheckHandler {
    /**
     * Проверяет статус платежа в X Payment Provider по заданному идентификатору. Если статус нетерминальный, то метод
     * возвращает false. В противном случае, отправляет асинхронное уведомление Payment Service o измененном статус
     * платежа и возвращает true.
     *
